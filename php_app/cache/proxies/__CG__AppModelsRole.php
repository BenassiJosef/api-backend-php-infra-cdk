 ...
 */
class Role extends \App\Models\Role implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Role' . "\0" . 'id', '' . "\0" . 'App\\Models\\Role' . "\0" . 'name', '' . "\0" . 'App\\Models\\Role' . "\0" . 'legacyId', '' . "\0" . 'App\\Models\\Role' . "\0" . 'organizationId', '' . "\0" . 'App\\Models\\Role' . "\0" . 'organization', '' . "\0" . 'App\\Models\\Role' . "\0" . 'createdAt'];
        }
