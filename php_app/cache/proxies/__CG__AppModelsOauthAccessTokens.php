 ...
 */
class OauthAccessTokens extends \App\Models\OauthAccessTokens implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\OauthAccessTokens' . "\0" . 'accessToken', '' . "\0" . 'App\\Models\\OauthAccessTokens' . "\0" . 'clientId', '' . "\0" . 'App\\Models\\OauthAccessTokens' . "\0" . 'userId', '' . "\0" . 'App\\Models\\OauthAccessTokens' . "\0" . 'expires', '' . "\0" . 'App\\Models\\OauthAccessTokens' . "\0" . 'scope'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OauthAccessTokens $proxy) {
