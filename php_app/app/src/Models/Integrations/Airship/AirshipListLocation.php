<?php
/**
 * Created by jamieaitken on 2019-07-04 at 12:45
 ...
 * AirshipListLocation
 *
 * @ORM\Table(name="airship_list_location")
 * @ORM\Entity
 */
class AirshipListLocation
{

    public function __construct(string $serial, string $detailsId, string $contactListId, string $contactListName, string $event)
    {
        $this->serial          = $serial;
